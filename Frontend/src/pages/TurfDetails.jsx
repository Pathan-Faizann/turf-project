...
function TurfDetails() {
  ...
  useEffect(() => {
    if (date) {
      API.get(`/bookings/${id}?date=${date}`).then((res) =>
    ...
    return (
      <div className="h-screen bg-[#020617] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-500 mt-2 text-sm">
          You need to be logged in to book a turf.
        </p>
        <button
          onClick={() => navigate("/login")}
          className="mt-6 bg-blue-600 px-8 py-3 rounded-xl font-black text-xs uppercase tracking-widest text-white shadow-lg shadow-blue-600/20"
        >
          Login Now
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              ...
              <div className="mt-10 space-y-4">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] block ml-1">
                  Select Booking Date
                </label>
                <div className="relative group">
                  ...
                  />
                  <CalIcon
                    className="absolute right-4 top-4 text-gray-600 group-focus-within:text-blue-500"
                    size={18}
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/5 border border-white/5 p-5 rounded-[2rem] text-center">
                <span className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1">
                  Price
                </span>
          ...
          <div className="lg:col-span-7">
            <motion.div
              ...
              className="bg-[#0f172a]/40 border border-white/10 p-8 md:p-10 rounded-[2.5rem] backdrop-blur-3xl h-full flex flex-col"
            >
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="text-xl font-black uppercase tracking-widest">
                    Available <span className="text-blue-500">Slots</span>
                  </h3>
                  <p className="text-gray-500 text-[10px] font-bold mt-1 uppercase tracking-widest">
                    Click on a time to reserve
                  </p>
                </div>
              ...
              {!date ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-10 border-2 border-dashed border-white/5 rounded-[2rem]">
                  ...
                  <p className="text-gray-500 font-bold text-xs uppercase tracking-widest">
                    First, choose a date to see availability
                  </p>
                </div>
              ) : (
                  ...
                  {turf.slots.map((slot, i) => {
                    ...
                    return (
                      ...
                      >
                        {slot}
                        {isBooked && (
                          <span className="absolute top-1 right-2 text-[8px] uppercase">
                            Booked
                          </span>
                        )}
                      </motion.button>
              ...
              <div className="mt-auto pt-10">
                ...
                <p className="text-center text-[9px] text-gray-600 mt-6 font-bold uppercase tracking-widest">
                  By booking, you agree to ArenaX Terms & Conditions
                </p>
              </div>
            </motion.div>
          </div>
